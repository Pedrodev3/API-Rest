...
import br.com.fiap.bo.IdiomaBO;
import br.com.fiap.to.IdiomaTO;

@Path("/idiomas")
public class IdiomaResource {

	private IdiomaBO eb = new IdiomaBO();

	// Cadastrar / Insert / Post (Postman)
	@POST
	@Consumes(MediaType.APPLICATION_JSON)
	public Response cadastrar(IdiomaTO et, @Context UriInfo uriInfo) {
		...
		builder.path(Integer.toString(et.getIdIdioma()));
	...
	@Path("/{id}")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response atualizar(IdiomaTO et, @PathParam("id") int id) {
	...
	public ArrayList<IdiomaTO> buscar(@PathParam("id") int id) {
		return eb.listar(id);
	}
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public ArrayList<IdiomaTO> buscarTodos() {
